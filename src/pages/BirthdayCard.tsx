        ...
        >
          <div className={`transition-all duration-500 ${cardFlipped ? 'opacity-0 hidden' : 'opacity-100'}`}>
            ...
            <div className="text-center">
              ...
              <p className="text-2xl text-gray-700 font-light mb-8">to the most wonderful person</p>
          ...
          <div className={`transition-all duration-500 ${cardFlipped ? 'opacity-100' : 'opacity-0 hidden'}`}>
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-4 text-gray-700 font-light text-lg leading-relaxed">
                <p>
                  Today is a celebration of you—of your beautiful heart, your infectious laughter, 
                  and the countless ways you make my life extraordinary.
                </p>

                <p>
                  From the moment you came into my life, everything changed for the better. You've taught me 
                  what it means to love unconditionally, to dream bigger, and to appreciate the precious moments 
                  we share together.
                </p>

                <p>
                  On your special day, I want you to know that you are my greatest blessing, my favorite adventure, 
                  and my forever love. Every day with you is a gift I never want to take for granted.
                </p>
